                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-8 mx-auto">
                        <SectionTitle
                            ...
                            excerpt="Powering businesses with comprehensive digital and <br class='d-none d-xl-block' /> online solutions for success in the digital age."
                        />
                    </div>
                </div>
                ...
                <div className="row mb-n7 align-items-center">
                    ...
                    <div className="col-xl-4 mb-7 order-md-1 order-xl-0">
                        <div className="service-media-img text-center">
                            <img
                                src={`${process.env.PUBLIC_URL}/images/service/inspirebyte-services.webp`}

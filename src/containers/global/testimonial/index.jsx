    ...
    return (
        <div className="testimonial-section section-py position-relative">
            <img
                ...
                src={`${process.env.PUBLIC_URL}/images/testimonial/inspirebyte-testimonial-shape.webp`}
                ...
                <div className="row mb-n7">
                    <div className="col-xl-7 col-lg-6 mb-7">
                        ...
                        >
                            <div data-depth="0.2">
                                <img
                                    src={`${process.env.PUBLIC_URL}/images/testimonial/inspirebyte-testimonials.webp`}
